...
# ax.plot([i+1 for i in range(n_epochs+1)], loss_sgd, label='sgd', alpha=0.5)
# ax.plot([i+1 for i in range(n_epochs+1)], loss_psgd, label='sgd projected', alpha=0.5)
# ax.plot([i+1 for i in range(n_epochs+1)], loss_smd, label='smd', alpha=0.5)
# ax.plot([i+1 for i in range(n_epochs+1)], loss_seg, label='seg', alpha=0.5)
# ax.plot([i+1 for i in range(n_epochs+1)], loss_adagrad, label='adagrad', alpha=0.5)
